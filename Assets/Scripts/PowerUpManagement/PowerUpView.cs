...
namespace PowerUpManagement
{
    public class PowerUpView
    {
        ...
        public PowerUpView(PowerUpCreator powerUpCreator, LevelPresenter levelPresenter, BoardCreationData boardCreationData)
        {
        ...
        public void CreatePowerUp(PowerUpType tempType, BoardLocation location)
        {
            ...
            var prefab = SpawnPowerUp(new Vector3(location.x, location.y), tempType);
        ...
        private GameObject SpawnPowerUp(Vector3 position, PowerUpType type)
        {
            var prefab = Object.Instantiate(GetPrefab(type), position, Quaternion.identity, parent: _powerUpParent.transform);
